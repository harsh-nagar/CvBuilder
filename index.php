    ...
    <div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="resume.png" alt="login" class="login-card-img">
          </div>
          <div class="col-md-7">
            <div class="card-body">
              ...
              <form action="logincheck.php" method="post">
                ...
                <p class="login-card-footer-text">Don't have an account? <a href="RegisterUser.php" class="text-reset">Register here</a></p>
            </div>
          </div>
        </div>
      </div>
