        ...
        <div class="container-fluid mb-3">
            <div class="row px-5 " style="justify-content: space-evenly;">
                ...
                <div class="col-md-8 col-sm-12 col-lg-6 bg-white box  ">
                    <form class="p-2" method="post" action="education.php">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 col-sm-4 col-lg-4">
                                <select name="country" class="form-control" style="margin-top:10px;cursor:pointer;width:100%;" required>
                        ...
                        <div class="form-row">
                            <div class="col-md-8 col-sm-8 col-lg-8">
                                <textarea name="jobdescription" placeholder="Job Description" class="form-control mt-2" required></textarea>
                            </div>
                        </div>
                        <div class="wrap">
                        ...
                        <div class="form-row ">
                            <!--<div class="col-md-4 col-sm-4 col-lg-4"> <button name="addbutton"
                                        class="btn btn-primary add_button" style="margin-top: 20px;">Add more</button></div>-->
                            <div class="col-md-8 col-sm-4 col-lg-8 "> <input class="btn btn-primary" type="submit" name="next" value="Next" id="next"></div>
                        </div>
